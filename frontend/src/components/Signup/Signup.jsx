...
export const Signup = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        axiosInstance
            .post("/api/v2/user/create-user", newForm,{
                headers:config
            })
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col  py-12 sm:px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                <h2 className="mt-6 text-center text-3xl font-Poppins font-extrabold text-gray-900">
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <input
                                    ...
                                    className="appearance-none  w-full px-3 py-2 border border-gray-500 rounded-md shadow-sm
